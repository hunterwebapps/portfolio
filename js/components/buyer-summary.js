const BUYER_SUMMARIES = {
  'ai-vision-agent': {
    symptom: 'Operators were spending too much time driving WMS, ERP, and portal screens by hand.',
  ...
  'modern-ops-on-legacy-erp': {
    ...
    pattern: 'Live shipment dashboard over an existing ERP.',
  ...
  'amazon-routing': {
    symptom: 'Amazon routing required a fragile chain of email reading, data shaping, API submission, polling, and WMS/ERP close-out.',
    pattern: 'End-to-end retailer workflow orchestration.',
    changed: 'Email-in to SP-API submission, async polling, confirmation, and WMS/ERP close-out run without human touch unless an exception needs review.',
